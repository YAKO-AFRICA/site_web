...
<body>
    <div class="a4-container">
                    ...
                    <table border="1" cellpadding="5" cellspacing="0" width="100%">
                        ...
                        @foreach($assures as $assure)
                            <tr>
                                ...
                                <td>
                                    @if(!empty($assure['DateEffet']))
                                        {{ \Carbon\Carbon::createFromFormat('d/m/Y', $assure['DateEffet'])->format('d-m-Y') }}
                                    @else
                                        -
                                    @endif
                                </td>                                
        ...
        <section class="ynov-fixed-center" style="height: 100%; width: 85%;  margin: 0 auto; overflow: hidden;"> 
        ...
        <script type="text/php">
            if (isset($pdf)) {
                ...
                $pdf->page_text(
                    $pdf->get_width() - 70,  // Position X (droite)
                    $pdf->get_height() - 30, // Position Y (bas)
                    "Page {PAGE_NUM} / {PAGE_COUNT}", // Texte
                    $font, // Police
                    10, // Taille
                    array(0, 0, 0) // Couleur (noir)
                );
            }
        </script>
