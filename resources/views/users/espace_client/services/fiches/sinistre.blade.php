                ...
                <section class="section-identificatio" style="margin-top: -45px; padding: 0 -70px; ">
                    <div class="section-documents" style="background-color: #E7F0EB; margin: 2px -20px; height: 150px; padding: 0px 10px;">
                        <div class="form-group" style="width: 60%; float: left; padding-top: 2px;">
                            <p style="text-align: justify;"> <span style="font-weight: bold; color: red;">NB : </span> <small style="">Cher <b>{{ $sinistre->prenomDecalarant }} {{ $sinistre->nomDecalarant}}</b>,<br> Nous vous informons que vous êtes prié de vous présenter à l’agence Yako Africa, muni des originaux des documents transmis lors de votre prédéclaration de sinistre, dès réception du message confirmant son acceptation. Cette étape est nécessaire afin de finaliser votre déclaration de sinistre.</small></p>
                            ...
                            <p style="margin-top: 7px">Fait à {{ $sinistre->lieuresidenceDecalarant }} le {{ \Carbon\Carbon::parse($sinistre->created_at)->translatedFormat('d F Y') ?? '.' }} </p>
                        </div>
