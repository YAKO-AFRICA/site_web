                            ...
                            <ul>
                                ...
                                <li style="margin-left: 50px">
                                    ...
                                    style="
                                        ...
                                        color: #F7A400;
                                        border-radius: 3px;
                                        background-color: #ffffff;" name="prenom" value="{{ $prestation->typeprestation === 'Avance ou prêt' ? 'X' : '.' }}" />
                                </li><br>
                                <li style="margin-left: 50px">
                                    ...
                                    style="
                                        ...
                                        color: #F7A400;
                                        border-radius: 3px;
                                        background-color: #ffffff;" name="prenom" value="{{ $prestation->typeprestation === 'Remboursement' ? 'X' : '.' }}" />
                                </li>
                            </ul>
