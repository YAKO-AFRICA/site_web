...
<body>
    ...
    <main class="main">
        <section class="main-section" style="position: relative; height: 100%; width: 100%; overflow: hidden;">
            ...
            <div class="content" style="padding: 0px 20px; margin-top: 14px;">
               ...
               <div class="clear" style="clear: both; margin-top: -75px;"></div>
                ...
                {{-- <section class="section-signature" style="border: #fff solid 1px">
                    ...
                    <div class="Signature">
                        <h6>Signature du déclarant</h6><small>
                            <p style="font-size: 0.57em; margin-top: -98px; margin-left:130px">Contrôle éffectué par
                                OTP du 17/12/2024 14:52</p>
                        </small>
                        <div class="form-group">
                    ...
                    <label for="signature"
                        style="position: absolute; top: 200px; left: 200px; max-height: 65px; max-width: 65px;">
                        <img src="data:image/jpg;base64,{{ base64_encode(file_get_contents(public_path('cust_assets/images/logo.png'))) }}"
                            alt="Yako Africa Logo" style="height: 65px; width: 65px" class="logo">
                    </label>
            ...
            {{-- <section class=""
                style="background-color: #E7F0EB; padding: 0px 20px; height: 322px; margin-top: -15px;">
                ...
                <div class="form-group" style="margin-top: 15px">
                    <label for="" style="margin-right: 2px;">Date RDV
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <input type="text" id=""
                        style="
                            width: 40%;
                    ...
                    <label for="prenom" style="margin-right: 2px;">Code RDV
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <input type="text" id="prenom"
                        style="
                            width: 15%;
                ...
                <div class="form-group" style="margin-top: 10px">
                    <label for="" style="margin-right: 2px;">Montants <br> des
                        primes</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="form-group" style="margin-top: 20px">
                    ...
                    <label for="prenom">Bulletin de souscription Invest &nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;</label>
                    <input type="text"
                        style="width: 4%; margin-bottom: -7px; border: 1px solid #90C8A7; padding: 5px; font-size: 14px; text-align:center; color: #F7A400; border-radius: 3px; background-color: #ffffff;"
                    ...
                    <input type="text"
                        style="width: 4%; margin-bottom: -7px; border: 1px solid #90C8A7; padding: 5px; font-size: 14px; text-align:center; color: #F7A400; border-radius: 3px; background-color: #ffffff;"
                        value="X" /> <br><br>
                    <label for="prenom">Attestation de <br> déclaration de <br>perte du contrat &nbsp;
                        &nbsp;&nbsp;&nbsp; </label>
                    <input type="text"
