        ...
        <div class="modal-content">
            ...
            <div id="OTPSendID">
                <form action="" method="post" id="sendOTPForm">
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="operation_type" id="operation_type" value="Pré-déclaration sinistre">
            ...
            <div id="OTPVerifyID" class="d-none">
                ...
                <form action="" method="post" id="verifyOTPForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn2 border-btn2 p-2" id="changePhoneButtonForMobileMoney" disabled>Modifier le numéro</button>
                        <button type="button" class="btn2 border-btn2 p-2" id="changePhoneButton" disabled>Modifier le numéro</button>
