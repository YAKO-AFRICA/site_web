        ...
        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="type[]" value="" id="DocName" required>
                                    </div>
                                </div> 
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-end gap-3">
                    ...
                    <button type="submit" class="btn-prime btn-prime-two" id="submit-btnPrest">Soumettre</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <p class="text-center mb-0">
                        <small><i id="docMsgerror" class="text-danger"></i></small>
                        <small><i id="docMsgsuccess" class="text-success"></i></small>
                    </p>
                </div>
            </div>
        </div>
