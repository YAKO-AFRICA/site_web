            ...
            <p class="mb-4">
                <strong>Pour toutes modifications de vos informations personnelles, veuillez Cliquez
                    <i><a href="javascript:;"
                            ...
                            data-url="{{ route('customer.prestation.modifyInfosPerso', $contratDetails['IdProposition']) }}"
                            data-title="Vous souhaitez modifier vos informations personnelles ?"
                            data-id="{{ $contratDetails['IdProposition'] }}" data-param="0"
                            data-route="{{ route('customer.prestation.modifyInfosPerso', $contratDetails['IdProposition']) }}">
                            ici
                        </a></i>
        ...
        <div class="card-body">
            ...
            <div class="etape" id="etape1">
                <div class="row g-3 mb-3">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom"
                            value="{{ Auth::guard('customer')->user()->membre->nom ?? '' }}" placeholder="Votre Nom"
                            readonly>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-12 col-lg-6">
                        <label for="cel" class="form-label">Sur quelle N° de téléphone pouvons nous vous contacter
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <select name="sexe" id="genre" class="form-control" readonly>
                            <option value=""></option>
                            <option value="M"
                                {{ Auth::guard('customer')->user()->membre->sexe === 'M' ? 'selected' : '' }}>Masculin
                            </option>
                            <option value="F"
                                {{ Auth::guard('customer')->user()->membre->sexe === 'F' ? 'selected' : '' }}>Feminin
                            </option>
                        </select>
                    </div>
                </div>
