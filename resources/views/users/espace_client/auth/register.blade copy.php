        ...
        <div class="section-authentication-cover">
            <div class="">
                <div class="row g-0">
                    ...
                    <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex" height="65vh">
                                        ...
                                        <form id="registerFormulaire" action="{{ route('customer.register')}}" method="POST" class="submitForm">
                                            ...
                                            <div class="stepRegister d-none" id="stepRegister3">
                                                ...
                                                <div class="input-group mb-3" id="show_hide_password">
                                                    ...
                                                    @error('password')
                                                        <span class="text-danger">Veuillez entrer votre nouveau mot
                                                            de passe</span>
                                                    @enderror
                                                </div>
