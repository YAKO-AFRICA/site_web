...
<head>
	...
	<title>Customer reset password || Yako Africa Assurances Vie</title>
                ...
                <div class="row g-0">
                    <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
                            <div class="card-body">
                                <img src="{{ asset('cust_assets/images/login-images/reset-password-cover.svg')}}" class="img-fluid" width="600" alt=""/>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    ...
                                    <div class="text-start mb-4">
                                        ...
                                        <p class="mb-0">S'il vous plaît, entrez un nouveau mot de passe.</p>
                                    </div>
                                    
                                    <div class="form-body">
                                        <form id="resetPasswordForm" action="{{ route('customer.resetPass' , $token)}}" method="POST">
                                            @if (Session::get('fail'))
                                            ...
                                            <div class="mb-3 mt-4">
                                                ...
                                                <span class="text-danger" id="resetPassMsgerror"></span>
                                            </div>
                                            <input type="hidden" id="modifier-login" name="login"> 
                                            <div class="mb-4">
                                                <label for="inputChoosePasswor" class="form-label">Ressaisir le mot de passe</label>
                                                <div class="input-group" id="show_hide_password">
    ...
    if (login) {
        ...
        .then(data => {
            ...
            if (data.customer.isFirstLog == 0 && data.customer.estajour == 1) {
                ...
                document.getElementById('message').textContent = "Pour plus de securité espace client, nous vous demandons de bien vouloir motifier votre mot de passe.";  // Message ajouté
                ...
                document.getElementById('forgetPasswordDiv').classList.add('d-none');
                document.getElementById('submitBtu').classList.add('d-none');
                document.getElementById('message').textContent = "Votre compte n'est pas à jour, veuillez faire la mise à jour du compte."; // Message ajouté
                ...
                document.getElementById('message').textContent = "";  // Réinitialiser le message s'il n'y a rien à signaler
            }
        } else {
            // Client non trouvé
            document.getElementById('btn-modifier').classList.add('d-none');
            ...
            document.getElementById('message').textContent = "Vous n'avez pas encore de compte Ynov, veuillez une une de creation de compte."; // Message ajouté
        }
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const resetPasswordForm = document.querySelector('#resetPasswordForm');
            ...
            const msgError = $('#resetPassMsgerror');
