        ...
        <div class="w-100 d-flex justify-content-center align-items-center" style="height: 90%">
            <div class="d-flex justify-content-center align-items-center" style="height: 100%; width:80%;">
                <a href="{{ route('customer.dashboard')}}">
                    <img src="{{ asset('cust_assets/images/logo-icon.png')}}" style="height: 100%; width:80%;" class="logo-icon img-fluid" alt="logo icon">
...
<header class="top-header">
                ...
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="user-info text-white">
                        <p class="user-name text-white mb-0">
                            @if(Auth::guard('customer')->check())
                                {{Auth::guard('customer')->user()->membre->nom ?? ''}} | {{Auth::guard('customer')->user()->membre->prenom ?? ''}}
                            @endif
                        </p>
                 ...
                 @if(Auth::guard('customer')->check())
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item d-flex align-items-center" href="{{ route('customer.dashboard')}}"><i class="bx bx-home-circle fs-5"></i><span>Dashboard</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('customer.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    ...
    <div class="modal fade" id="enMaintenanceModal" tabindex="-1" aria-labelledby="enMaintenanceModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
