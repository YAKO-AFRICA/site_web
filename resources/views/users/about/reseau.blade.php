                    ...
                    <div class="services__tab-wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="health-tab-pane" role="tabpanel" aria-labelledby="health-tab" tabindex="0">
                                <div class="services__item-four shine-animate-item">
                                    <div class="services__thumb-four shine-animate">
                                        <img src="{{ asset('assets/img/images/partenaire-banque.jpg')}}" alt="">
                                    </div>
                            ...
                            <div class="tab-pane fade" id="travel-tab-pane" role="tabpanel" aria-labelledby="travel-tab" tabindex="0">
                                <div class="services__item-four shine-animate-item">
                                    <div class="services__thumb-four shine-animate">
                                        <img src="{{ asset('assets/img/images/partenaire-courtier.jpg')}}" alt="">
                                    </div>
                                    <div class="services__content-four">
...
<script>
    ...
    // Ajouter des marqueurs si nécessaire
    var marker1 = L.marker([5.3240576, -4.02422]).addTo(map)
      .bindPopup("<b>Yako Africa Assurances Vie</b><br>Abidjan, Côte d'Ivoire.");
    var marker2 = L.marker([5.3194167, -4.0126667]).addTo(map)
      .bindPopup("<b>Position Supplémentaire</b><br>Coordonnées supplémentaires.");
  
    // Optionnel : Ajouter un contrôle de géocodage pour rechercher des lieux
