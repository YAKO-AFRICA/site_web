...
@section('content')
            ...
            <div class="row justify-content-cente">
                <div class="col-lg-12">
                    @if ($aboutHist && $aboutHist->image)
                        <img src="{{ asset('images/AboutPage/' . $aboutHist->image) }}" class="img-main img-fluid"
                            alt="historique YAKO Africa">
                    @else
                        <img src="{{ asset('assets/img/images/historique.png') }}" class="img-main img-fluid"
                            alt="historique YAKO Africa">
                    @endif
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-9 col-sm-10 mb-30">
                    <div class="about__img-wrap-four about__img-wrap-home8">
                        ...
                        @endif
                        <div class="shape">
                            <img src="{{ asset('assets/img/home8/shape-circle.png') }}" alt=""
    ...
    <section class="counter-area py-5" id="chiffre_cle">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            <img src="{{ asset('assets/img/icon/capital-risque.png') }}" width="85px" height="85px"
                                alt="icon">
                    ...
                    <div class="counter-item">
                        <div class="content w-100">
                            ...
                            <p class="count text-center m-auto p-0"
                                style="font-size: 1.2em; font-weight: normal; width:46%"><span class="odometer"
                                    data-count="3"></span>M+ FCFA</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            ...
                            <img src="{{ asset('assets/img/icon/equipe.png') }}" width="85px" height="85px"
                                alt="icon">
                        </div>
                    </div>
                    <div class="counter-item">
                        <div class="content w-100">
                            ...
                            <p class="count  m-auto" style="font-size: 1.2em; font-weight: normal; width:46%"><span
                                    class="odometer text-center" data-count="312"></span> &nbsp; staffs</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            ...
                            <img src="{{ asset('assets/img/icon/famille.png') }}" width="85px" height="85px"
                                alt="icon">
                        </div>
                    </div>
                    <div class="counter-item">
                        <div class="content w-100">
                            ...
                            <p class="count  m-auto" style="font-size: 1.2em; font-weight: normal; width:46%">+<span
                                    class="odometer" data-count="25"></span>K</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            {{-- <i class="flaticon-trophy"></i> --}}
                            <img src="{{ asset('assets/img/icon/prestations.png') }}" width="85px" height="85px"
                                alt="icon">
                        </div>
                    </div>
                    <div class="counter-item m-auto">
                        <div class="content w-100">
                            ...
                            <p class="count  m-auto" style="font-size: 1.2em; font-weight: normal; width:46%"><span
                                    class="odometer" data-count="51"></span>M+ FCFA</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center text-center">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            {{-- <i class="flaticon-happy"></i> --}}
                            <img src="{{ asset('assets/img/icon/argent.png') }}" width="85px" height="85px"
                                alt="icon">
                        </div>
                    </div>
                    <div class="counter-item">
                        <div class="content w-100">
                            ...
                            <p class="count  m-auto" style="font-size: 1.2em; font-weight: normal; width:46%">+<span
                                    class="odometer" data-count="10"></span> M+ FCFA</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            ...
                            <img src="{{ asset('assets/img/icon/cote-divoire.png') }}" width="85px" height="85px"
                                alt="icon">
                    ...
                    <div class="counter-item">
                        <div class="content w-100">
                            <h2 class="count  m-auto" style="width:46%"><span class="odometer" data-count="14"></span>+
                            </h2>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            ...
                            <img src="{{ asset('assets/img/icon/preuves.png') }}" width="85px" height="85px"
                                alt="icon">
                        </div>
                    </div>
                    <div class="counter-item">
                        <div class="content w-100">
                            ...
                            <p class="count  m-auto" style="font-size: 1.2em; font-weight: normal; width:46%">+<span
                                    class="odometer" data-count="400"></span> &nbsp;K</p>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="counter-item">
                        <div class="icon m-auto">
                            {{-- <i class="flaticon-time"></i> --}}
                            <img src="{{ asset('assets/img/icon/solvabilite.png') }}" width="85px" height="85px"
                                alt="icon">
                        </div>
                    </div>
                    <div class="counter-item">
                        <div class="content w-100">
                            ...
                            <p class="count  m-auto mb-3" style="font-size: 1.2em; font-weight: normal; width:46%"><span
                                    class="odometer" data-count="5"></span>.5M+ FCFA</p>
                            <p>Couverture des Engagements</p>
                            <p class="count  m-auto mb-3" style="font-size: 1.2em; font-weight: normal; width:46%"><span
                                    class="odometer" data-count="127"></span>%</p>
                            <p>Total Bilan</p>
                            <p class="count  m-auto" style="font-size: 1.2em; font-weight: normal; width:46%"><span
                                    class="odometer" data-count="36"></span>.7M+ FCFA</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="counter-shape-wrap">
            <img src="{{ asset('assets/img/images/counter_shape01.png') }}" alt="" data-aos="fade-right"
                data-aos-delay="400">
            <img src="{{ asset('assets/img/images/counter_shape02.png') }}" alt=""
                data-parallax='{"x" : 100 , "y" : -100 }'>
            <img src="{{ asset('assets/img/images/counter_shape03.png') }}" alt="" data-aos="fade-left"
                data-aos-delay="400">
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="section-content">
                        <p style="text-align: justify">Notre équipe d'experts met à votre disposition une vaste expérience
                            dans le domaine de l'assurance. Que ce soit pour protéger vos biens ou garantir votre avenir,
                            nous vous offrons des solutions fiables, adaptées à vos besoins spécifiques, ainsi qu'un
                            accompagnement de confiance à chaque étape de votre vie.</p>
                    </div>
                </div>
            </div>
            ...
            @if (($DGs || $PCA || $teams || $teams2) && $DGA)
                <div class="team-item-wrap">
                    @if ($PCA)
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal{{ $PCA->uuid }}" tabindex="-1"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body row">
                                        ...
                                        <div class="col-md-7  p-2" style="text-align:justify;">
                                            ...
                                            <img src="{{ asset('assets/img/logo/Logo_yako.png') }}" alt="Logo"
                                                class="img-fluid d-block m-auto" style="max-width: 200px !important;">
                                        </div>
                                    </div>
                                ...
                                <div class="team-item team-yako">
                                    <div class="team-thumb">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal{{ $PCA->uuid }}">
                                            <img src="{{ asset('images/Teams/' . $PCA->team_image) }}" alt="">
                                        </a>
                                    ...
                                    <div class="team-content">
                                        <h4 class="title text-center">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal{{ $PCA->uuid }}">{{ $PCA->team_name }}</a>
                                        </h4>
                    ...
                    <div class="row justify-content-center">
                        @foreach ($DGs as $DG)
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal{{ $DG->uuid }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                                <div class="team-item team-yako">
                                    <div class="team-thumb">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal{{ $DG->uuid }}">
                                            <img src="{{ asset('images/Teams/' . $DG->team_image) }}" alt="">
                                        </a>
                                    ...
                                    <div class="team-content">
                                        <h4 class="title text-center">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal{{ $DG->uuid }}">{{ $DG->team_name }}</a>
                                        </h4>
                    ...
                    <div class="row justify-content-center">
                        @foreach ($teams as $team)
                            <div class="modal fade" id="exampleModal{{ $team->uuid }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-8">
                                <div class="team-item team-yako">
                                    <div class="team-thumb">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal{{ $team->uuid }}">
                                            <img src="{{ asset('images/Teams/' . $team->team_image) }}" alt="">
                                        </a>
                                    </div>
                                    <div class="team-content">
                                        <h4 class="title text-center"><a href="#" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal{{ $team->uuid }}">{{ $team->team_name }}</a>
                                        </h4>
                    ...
                    <div class="row justify-content-center">
                        @foreach ($teams2 as $team2)
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal{{ $team2->uuid }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                                <div class="team-item team-yako">
                                    <div class="team-thumb">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal{{ $team2->uuid }}">
                                            <img src="{{ asset('images/Teams/' . $team2->team_image) }}" alt="">
                                        </a>
                                    ...
                                    <div class="team-content">
                                        <h4 class="title text-center">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal{{ $team2->uuid }}">{{ $team2->team_name }}</a>
                                        </h4>
                ...
                <div class="team-item-wrap">
                    ...
                    <div class="row justify-content-center">
                        @foreach ($teams1 as $team1)
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal{{ $team1->uuid }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                                <div class="team-item team-yako">
                                    <div class="team-thumb">
                                        <a href="#" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal{{ $team1->uuid }}">
                                            <img src="{{ asset('images/Teams/' . $team1->team_image) }}" alt="">
                                        </a>
                                    ...
                                    <div class="team-content">
                                        <h4 class="title text-center">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal{{ $team1->uuid }}">{{ $team1->team_name }}</a>
                                        </h4>
                            ...
                            <ul class="list-wrap">
                                <li>
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Abidjan - Plateau, Rue de Commerce, Immeuble Pacifique en face de l'Immeuble du
                                            MALI</p>
                                    </div>
                                </li>
                                <li>
